...
import Operaciones.AreaEsf;

import Operaciones.Triangulo;
...
public class PantallaP extends JDialog {
    ...
    private void jButton3_actionPerformed(ActionEvent e) {
        if(!jTextField1.getText().equals("")&&!jTextField2.getText().equals("")){
            ...
            Triangulo tri = new Triangulo(Integer.parseInt(jTextField2.getText()), Integer.parseInt(jTextField1.getText()));
            jTextArea1.setText(String.valueOf(tri.getArea()));
        }
        else
    ...
    private void jButton4_actionPerformed(ActionEvent e) {
        if(!jTextField1.getText().equals("")){
            ...
            AreaEsf ae = new AreaEsf(Float.parseFloat(jTextField1.getText()));
            jTextArea1.setText(String.valueOf(ae.getArea()));
        }
        else
